...
# Définition de la classe abstraite Produit
class Produit(ABC):
...
# Définition de la classe ProduitElementaire
...
# Définition de la classe ProduitCompose
...
# Créer des produits élémentaires
...
# Afficher les informations et tester getPrixHT
print(p1)
print(p2)
print(p3)
